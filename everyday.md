...
| 문제           | 링크                                      | solve |  난이도  | 비고  |
| ------------ | --------------------------------------- | :---: | :---: | --- |
| 에너지 모으기      | (https://www.acmicpc.net/problem/16198) |   O   |  쉬움   |     |
| 구간 나누기 2     | (https://www.acmicpc.net/problem/13397) |   O   |  어려움  |     |
| 벽 부수고 이동하기 3 | (https://www.acmicpc.net/problem/16933) |   O   |  어려움  |     |
...
| 문제                                      | 링크                                                         | solve |  난이도  | 비고  |
| --------------------------------------- | ---------------------------------------------------------- | :---: | :---: | --- |
| [베스트 앨범](programmers/베스트앨범/)            | (https://programmers.co.kr/learn/courses/30/lessons/42579) |
...
| 문제                        | 링크                                      | solve |  난이도  | 비고  |
| ------------------------- | --------------------------------------- | :---: | :---: | --- |
| [과외맨](beakjoon/5213/)     | (https://www.acmicpc.net/problem/5213)  |
...
| [소수 만들기](programmers/12977/) | (https://programmers.co.kr/learn/courses/30/lessons/12977) |
| [올바른 괄호](programmers/12909/) | (https://programmers.co.kr/learn/courses/30/lessons/12909) |
